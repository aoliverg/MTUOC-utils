...
def go():
    sdltmdir=E1.get()
    fsortida=E2.get()
    sdltm2tabtxtDIR(sdltmdir, fsortida)


top = Tk()
top.title("MTUOC-sdltm2tabtxtDIR-GUI")

B1=tkinter.Button(top, text = str("Input dir"), borderwidth = 1, command=select_corpusDIR,width=14).grid(row=0,column=0)
