...
def TMX2tabtxt(fentrada,fsortida,l1,l2):
    try:
...
if __name__ == "__main__":
    ...
    parser.add_argument('-s','--sl', nargs="+", action="store", dest="slcode", help='The code for the source language.',required=True)
    parser.add_argument('-t','--tl', nargs="+", action="store", dest="tlcode", help='The code for the target language.',required=True)
    ...
    TMX2tabtxt(fentrada,fsortida,l1,l2)
